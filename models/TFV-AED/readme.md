...
**Figure 2. AED water quality model diagram summarising interactions captured within Lake Erie (to be updated).**
...
The data necessary to simulate lake dynamics comprise boundary conditions at incoming rivers and meteorological forcing. 
The model requires meteorological inputs, including wind speed, solar radiation, air temperature, cloud cover, and relative humidity, for surface heat and momentum exchange calculations. 

The sediment was separated into XX zones based on their properties (sand/silt composition and N/P contents) based on the survey data presented in (Sed CHapter).

### Outputs

The key output variables are summarized in Table 1.
...
<tr style='mso-yfti-irow:41;mso-yfti-lastrow:yes'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoCommentText><b style='mso-bidi-font-weight:normal'><i
  style='mso-bidi-font-style:normal'><span style='font-size:6.0pt'>CGM<o:p></o:p></span></i></b></p>
  </td>
  <td width="13%" valign=top style='width:13.14%;border:none;border-bottom:
  solid windowtext 1.0pt;mso-border-bottom-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt'>
 ...
 <tr style='mso-yfti-irow:41;mso-yfti-lastrow:yes'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoCommentText><b style='mso-bidi-font-weight:normal'><i
  style='mso-bidi-font-style:normal'><span style='font-size:6.0pt'>BIV<o:p></o:p></span></i></b></p>
  </td>
  <td width="13%" valign=top style='width:13.14%;border:none;border-bottom:
  solid windowtext 1.0pt;mso-border-bottom-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt'>
...
**Table 1: Summary of the relevant variables resolved by the TUFLOW-FV – AED2 platform.**  
...
AED2 model website: http://aquatic.science.uwa.edu.au/research/models/AED/index.html 
