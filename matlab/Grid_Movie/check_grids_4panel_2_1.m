...
ncfile2 = 'Y:\Erie\tfv_011_Scn00\Output_1\erie_00_AED_diag.nc';
...
t0=datenum('20130507 00:00','yyyymmdd HH:MM');
tt1 = find(abs(timesteps2-t0)==min(abs(timesteps2-t0)));

t1=datenum('20130701 00:00','yyyymmdd HH:MM');
tt2 = find(abs(timesteps2-t1)==min(abs(timesteps2-t1)));
