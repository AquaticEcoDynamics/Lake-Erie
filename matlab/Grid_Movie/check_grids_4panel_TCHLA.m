...
ncfile = 'Y:\Erie\Erie_TFVAED_Scn00\Output.00\erie_00_AED.nc';
%ncfile2 = 'Y:\Erie\tfv_011_Scn00\Output\erie_00_AED.nc';
ncfile2 = 'Y:\Erie\GIS_Test\tfv_011_Scn00\Output\erie_00_AED.nc';



%%
%titles = {'WVHT','TAUB','PICKUP_TOTAL','TSS'}; %DEPOSITION_TOTAL
titles = {'WQ_DIAG_PHY_TCHLA','WQ_DIAG_PHY_TCHLA','WQ_PHS_FRP','WQ_PHS_FRP'}; %DEPOSITION_TOTAL
titles2 = {'Total Chla (ug/L): v10','Total Chla (ug/L): v11','FRP (mg/L): v10','FRP (mg/L): v11'}; %DEPOSITION_TOTAL
conv = [1 1 31/1000 31/1000];
caxt = [10 10 0.01 0.01];
...
img_dir = 'check_tchla_2\';

if ~exist(img_dir,'dir')
    mkdir(img_dir);
end

sim_name = [img_dir,'animation_TCHLA.mp4'];
...
for i=tt1:tt2
    ...
    for ii=1:4
        ...
        text(0.1,0.8,titles2{ii},'color','k','fontsize',12,'units','normalized');
        %title(titles2{ii});
        ...
        set(gca,'XTickLabel',[]);
%         
         xlim([542298.8387669                675161.444]);
         ylim([4689630.10308245          4760177.67447469]);
