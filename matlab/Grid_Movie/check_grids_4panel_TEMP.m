...
ncfile = 'Y:\Erie\Erie_TFVAED_Scn00\Output.00\erie_00_TFV.nc';
%ncfile2 = 'Y:\Erie\tfv_011_Scn00\Output\erie_00_AED.nc';
ncfile2 = 'Y:\Erie\GIS_Test\tfv_011_Scn00\Output\erie_00_1_TFV.nc';



%%
%titles = {'WVHT','TAUB','PICKUP_TOTAL','TSS'}; %DEPOSITION_TOTAL
titles = {'TEMP','TEMP','SAL','SAL'}; %DEPOSITION_TOTAL
titles2 = {'Temperature (C): v10','Temperature (C): v11','Salinity (psu): v10','Salinity (psu): v11'}; %DEPOSITION_TOTAL
conv = [1 1 1 1];
caxt = [15 15 0.05 0.05];
