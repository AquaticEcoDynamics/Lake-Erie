...
ncfile = 'D:\Studysites\Erie\Simulations\2013_tfv_erie_v1_WS_NC\Output\erie.nc';
geofile = 'D:\Studysites\Erie\Simulations\2013_tfv_erie_v1_WS_NC\Input\log\erie_geo.nc';
...
movie_title = 'Temperature (C)';

movie_name = 'Tempertaure_2013_v1_ELCDMet';
...
%         end
%         
%         val_1{n} = data.(varname)(i3:i3+NL-1);
%     
%     end
%     model_1.x = cell2mat(xv1);
%     model_1.z = cell2mat(zv1);
%     model_1.c = cell2mat(val_1');
...
%     
%     
    text(0.05,0.1,datestr(timesteps(i),'dd/mm/yyyy'),...
        'Units','Normalized',...
        'Fontname','Candara','fontweight','bold',...
        'Fontsize',20,'color','w');
...
%     
%   P1 = patch(model_1.x /1000,model_1.z,model_1.c','edgecolor','none');hold on
%     F1 = fill(fillX1,fillY1,[0.6 0.6 0.6]);
%     
%     xlim(xlimit1);
%     ylim(ylimit1);
%     xlabel('Distance from Eastern Bank (km)','fontsize',12,'FontWeight','bold','color','w');
%     ylabel('Depth (mAHD)','fontsize',12,'FontWeight','bold','color','w');
%     set(gca,'YColor','w','XColor','w','box','on');
%     text(0.05,0.1,'St Clair','Color','w','units','normalized','fontsize',16,'FontWeight','bold');
%     
%     caxis(CAX);  
