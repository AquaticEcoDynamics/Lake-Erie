...
outputdirectory = 'F:\Dropbox\Data_Erie\20180330\tfv_004_2013_MET_aed2_2018_BIV_ICE_RST\Fill_TS_Y_Scale\';
% ____________________________________________________________Configuration

% Models___________________________________________________________________


 ncfile(1).name = 'D:\Simulations\Erie\Lake Erie\TFVAED2\tfv_004_2013_MET_aed2_2018_BIV_ICE_RST\Output\erie_AED.nc';
 ncfile(1).symbol = {'-';'--'};
