...
def.cAxis(1).value = [-0.001 0.001];   %'WQ_DIAG_TOT_TN',...
...
def.cAxis(1).clip = [-0.001 0.001];   %'WQ_DIAG_TOT_TN',...
...
start_timeave = datenum(2013,05:10,01);
end_timeave = datenum(2013,06:10,01);
...
for i = 1:length(start_timeave)
    for j = 1:length(varname)
        ...
        erie_delmap_v2(ncfile1,ncfile2,varname{j},titletxt,def.cAxis(j).value,def.cAxis(j).clip,...
            start_timeave(i),end_timeave(i),outname);
    end
end
