...
var(int).nc = 'D:\Simulations\Erie\Lake Erie\TFVAED2\tfv_004_2013_MET_aed2_2018_BIV_ICE_RST\Output\erie_aed.nc';
var(int).conv = 1;
var(int).caxis = [0 0.8];
var(int).Title = 'BIV FRAC';
int = int  + 1;

var(int).name = 'WQ_MAG_CLADOPHORA';
var(int).nc = 'D:\Simulations\Erie\Lake Erie\TFVAED2\tfv_004_2013_MET_aed2_2018_BIV_ICE_RST\Output\erie_aed.nc';
var(int).conv = 1;
var(int).caxis = [0 30];
...
outputdir = 'F:\Dropbox\Data_Erie\20180330\tfv_004_2013_MET_aed2_2018_BIV_ICE_RST\Multisheet_BIV_2\';
